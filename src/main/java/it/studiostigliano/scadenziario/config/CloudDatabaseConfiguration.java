package it.studiostigliano.scadenziario.config;
...
@Configuration
@EnableMongoRepositories("it.studiostigliano.scadenziario.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("it.studiostigliano.scadenziario.config.dbmigrations");
